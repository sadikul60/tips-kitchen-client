...
const ClientFeedback = () => {
    return (
        <div className='my-20'>
            <h1 className='text-3xl font-bold pb-5'>Some Customer Feedback</h1>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 items-center'>
                <div className='card-two px-6 shadow-xl rounded-xl'>
                    ...
                    <p className='text-xl pb-8 text-start'>
                        I am Chitti. Hope everyone is well.
                ...
                <div className='card-two px-6 shadow-xl rounded-xl'>
                    ...
                    <p className='text-xl pb-8 text-start'>
                        I am Rita. Hope everyone is well.
                        I basically love to cook different types of food. And they reach you.
                        Hope you like my services. And pray that I can give you something new like this.
                        I hope you will always be by my side.</p>
                </div>
                <div className=' card-two px-6 shadow-xl rounded-xl'>
                    ...
                    <p className='text-xl pb-8 text-start'>
                        I am Rony. Hope everyone is well.
                        I basically love to cook different types of food. And they reach you.
                        Hope you like my services. And pray that I can give you something new like this.
                        I hope you will always be by my side.</p>
                </div>
